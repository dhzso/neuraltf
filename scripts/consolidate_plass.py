#!/usr/bin/env python
"""Consolidate Plass 2018 per-cell DGE files into one h5ad.
...
with their sample tag to keep them unique across samples); by default the
complete atlas is kept (pass --cells 10000, seed 42, to subsample for fast
dev runs) and writes `datasets/processed/plass_v6.h5ad`.

Usage:
    python scripts/consolidate_plass.py [--cells 0] [--seed 42]
