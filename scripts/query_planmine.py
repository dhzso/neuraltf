...
input was rank_neural.csv (143 genes) while ALL THREE prioritization
methods score the full rank.csv universe (11,696 genes) — the
...
def load_candidates(rank_csv: Path, repo: Path | None = None,
    ...
    Members:
      1. every gene in rank_neural.csv (the neural candidates — the
         previous 143-gene universe, fully preserved);
...
def main(argv: list[str] | None = None) -> int:
    ...
    # covered only 143 of the 11,696-gene scoring universe.
