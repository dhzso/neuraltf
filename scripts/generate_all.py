...
STEPS = [
    ...
    ("Generate publication figures",
     ...
     [["projects", "NeuralTF", "figures", "Fig1_candidate_landscape.png"],
      ["projects", "NeuralTF", "figures", "Fig2_evidence_architecture.png"],
      ["projects", "NeuralTF", "figures", "Fig3_ranking_robustness.png"],
      ["projects", "NeuralTF", "figures", "Fig4_stream_sensitivity.png"],
      ["projects", "NeuralTF", "figures", "Fig5_neural_filtering_scope.png"],
      ["projects", "NeuralTF", "figures", "Fig6_prioritized_candidate_atlas.png"]]),
    ("Generate supplementary tables",
