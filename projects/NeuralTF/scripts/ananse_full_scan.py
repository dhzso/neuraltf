...
Method:
  ...
  3. Map candidate v6_ids → h1SMcG via batch_v6_to_h1smcg().
...
Outputs:
  results/ananse_network_full.csv      — all candidates with network metrics
  results/ananse_top_regulators.csv    — top 20 by out-degree (TF targets)
  results/ananse_network_full.parquet  — machine-readable version
