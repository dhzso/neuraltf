...
def build_csv(top: pd.DataFrame) -> pd.DataFrame:
    # 2026-09-06 audit fix: same as dirichlet_uniform — the previous
    # dict(zip(...)) kept an arbitrary last-row v4 ID for the 7,619
    # ambiguous v6 mappings; now uses map_v6_to_v4 (blank + flagged
    # ambiguous), matching the fixed method.
