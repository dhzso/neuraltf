...
FIGURES = {
    ...
    38: ("38_loo_robustness.py",                  "Leave-one-atlas-out robustness"),
    39: ("39_score_uncertainty_forest.py",         "Score-uncertainty forest (weight perturbation)"),
    40: ("40_overall_vs_composite.py",             "Integrated vs composite score (bonus impact)"),
