"""Score distributions across all 11 evidence streams for the planarian genome.

Single-panel horizontal violin plot showing empirical density, median, and interquartile range (IQR)
of non-zero evidence scores for each of the 11 integrated evidence streams across all candidates.
"""
