...
def build():
    ...
    ax.set_title("Method agreement is high by construction\n"
                 "(shared matrix/bonuses/gate/tie-breaks; set-level hypergeometric\n"
                 "overlaps are the primary consensus statistics)",
