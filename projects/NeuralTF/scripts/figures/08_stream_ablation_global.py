...
def build():
    ...
    title_block(
        fig,
        f"Stream Ablation Impact Across Prioritized Neural TFs (N = {len(neural)})",
        "Each evidence stream removed in turn; |\u0394rank| = absolute rank change after stream removal",
    )
