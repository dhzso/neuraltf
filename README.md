...
python scripts/run_downstream.py             # Dirichlet UQ, ANANSE scan, tables & 31 figures
...
| `dirichlet_centered_top10.csv` | Dual-track top-10 shortlist under centered Dirichlet (5 RNA-screened + 5 Unscreened) |
| `dirichlet_uniform_top10.csv` | Dual-track top-10 shortlist under uniform Dirichlet (5 RNA-screened + 5 Unscreened) |
...
| **Not tested #2** | `dd_Smed_v6_18505_0_1` (**dd18505** / MSH1) | Homeodomain (msh1) |
| **Not tested #3** | `dd_Smed_v6_16466_0_1` (**dd16466** / FOXG1) | Forkhead; oral/neural forebrain ortholog |
...
| 15 | **Cross-Species Ortholog Benchmark** | `scripts/stats/ortholog_benchmark.py` | Conserved *H. sapiens* neural TF ROC-AUC (0.634 honest label-free) & Mann-Whitney test |
